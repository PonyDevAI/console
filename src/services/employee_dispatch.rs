use crate::models::{
    Agent, AgentProtocol, AgentSource, AgentSourceType, Employee, PersonaFiles, SoulFiles,
};
use anyhow::Result;
...
pub async fn dispatch(
    ...
    match protocol {
        AgentProtocol::LocalProcess {
            ...
            dispatch_local_process(executable, soul_arg, extra_args, &system_prompt, task, cwd)
                .await
        }
...
pub async fn dispatch_via_source(
    ...
    match source.source_type {
        ...
        AgentSourceType::RemoteOpenClawWs => Err(anyhow::anyhow!(
            "OpenClaw execution not supported in this version"
        )),
    }
}
